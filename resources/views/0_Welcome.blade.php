...
<body>
    <div class="parent clearfix">
        <div class="bg-illustration">
            <img style="margin-top: 100px; margin-left: 50px" src="assets/media/logos/1200px-Pertamina_Logo.png" alt="logo">
        ...
        <div class="login ps-20 ">
            <div class="login-logo pb-lg-4 ms-10">
                <img src="assets/media/logos/1200px-Pertamina_Logo.png" alt="" style="height: 50px; margin-top:100px"/>
            </div>
